const locale = {
  ...
  jaJP: {
    initial: {
      help:
        'ここを右クリックすると設定が開きます。ACTの「クリックを透過させる」がオフになっていることを確認してください。',
    },
    config: {
      setupTitle: '設定モード',
      nameTitle: 'キャラクター名',
      nameHelp: "あなたのキャラクター名:",
      themeTitle: 'カラーテーマ',
      themeOption1: 'ロールの色',
      themeOption2: '白黒',
      toggleTitle: '表示する項目',
      ...
      toggleOption6: '戦闘時間',
      toggleOption7: '合計DPS',
      toggleOption8: '与ダメージ割合',
      toggleOption9: 'Discord',
      toggleOption10: '言語',
      toggleOption11: '最大ヒット',
      toggleOption12: 'ジョブなしの戦闘データを表示',
      toggleOption13: '配信モードを有効化（すべての名前をぼかす）',
      ...
      resetTitle: 'リセット',
      discordTitle: 'Discord Webhook URL',
      discordHelp: 'DiscordのチャンネルからURLを取得してください',
      localeTitle: 'Language',
      localeOption1: 'English',
      localeOption1Value: 'enUS',
      localeOption2: 'Português',
      ...
      localeOption6Value: 'jaJP',
      help:
        '設定は自動的に保存されます。<br />このウィンドウは<strong>右クリック</strong>で開きます。',
    },
    setupMode: {
      instructionsTitle:
        '<strong>このウィンドウ内を右クリックすると設定が開きます！</strong>',
      instructions:
        '表示されているデータは実際のものではなく、あくまでもサンプルです。このオーバーレイを好きなように配置・設定することができます。実際のデータを得る場合は、木人を攻撃するか、実際に戦闘を行なってください。<br />また、このウィンドウの大きさを、ゲームのウィンドウの幅と同じくらいにしてください。',
    },
  },
}
