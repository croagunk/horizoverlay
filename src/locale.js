const locale = {
  ...
  jaJP: {
    initial: {
      help:
        'ACT内の「クリックを透過させる」のチェックがオフの状態で右クリックすると設定を開きます。',
    },
    config: {
      setupTitle: '設定モード',
      nameTitle: 'キャラクター名',
      ...
      toggleOption6: '戦闘時間',
      toggleOption7: '合計DPS',
      toggleOption8: 'ダメージ割合',
      toggleOption9: 'Discord',
      toggleOption10: '言語',
      toggleOption11: '最大ヒット',
      toggleOption12: '非戦闘職の結果を表示',
      toggleOption13: '配信モードを有効化 (名前をぼかす)',
      ...
      resetTitle: 'リセット',
      discordTitle: 'Discord Webhook URL',
      discordHelp: 'DiscordのチャンネルでURLを取得してください',
      localeTitle: '言語',
      localeOption1: 'English',
      localeOption1Value: 'enUS',
      localeOption2: 'Português',
      ...
      localeOption6Value: 'jaJP',
      help:
        '設定は自動で保存されます。<br />このウィンドウは<strong>右クリック</strong>で表示できます。',
    },
    setupMode: {
      instructionsTitle:
        '<strong>このウィンドウを右クリックすると設定を開きます！</strong>',
      instructions:
        '表示されているデータは実際のものではなく、オーバーレイを設定するためのサンプルデータです。実際のデータを表示するには、木人を攻撃するか実際に戦闘を行なってください。<br />また、設定ウィンドウのように、このウィンドウもサイズを変更することができます。',
    },
  },
}
